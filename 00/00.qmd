...
-   Aus den Punkten aller Wissensüberprüfungen werden zunächst die niedrigsten zwei Bewertungen entfernt. Von den übrigen Bewertungen wird der arithmetische Mittelwert berechnet -- diese Punkte fließen dann zu 60% in die Gesamtnote ein.
...
Die kleinste Punktanzahl einer Kategorie wird immer der besseren Note zugerechnet, d.h. z.B. exakt 9 Punkte entsprechen einem "Sehr gut". Der gewichtete Mittelwert wird nicht mehr gerundet, d.h. dass z.B. 8.97 Punkte der Note "Gut" entsprechen.
