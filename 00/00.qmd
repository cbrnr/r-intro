...
|--------:|-----------:|-------------------------|
| 1       |   2.3.2026 | Grundlagen              |
| 2       |   9.3.2026 | Die R-Umgebung          |
| 3       |  16.3.2026 | Vektoren                |
| 4       |  23.3.2026 | Tabellen                |
| 5       |  13.4.2026 | Daten importieren       |
| 6       |  20.4.2026 | Deskriptive Statistiken |
| 7       |  27.4.2026 | Datenaufbereitung       |
| 8       |   4.5.2026 | Grafiken                |
| 9       |  11.5.2026 | Korrelation             |
| 10      |  18.5.2026 | Lineare Regression (1)  |
| 11      |   1.6.2026 | Lineare Regression (2)  |
| 12      |   8.6.2026 | Mittelwertvergleich     |
| 13      |  15.6.2026 | Prüfung                 |
| 14      |  22.6.2026 | Prüfung (Ersatztermin)  |
...
::: {.callout-note}
Der Einsatz von Künstlicher Intelligenz, insbesondere von Large Language Models (wie z.B. [ChatGPT](https://chatgpt.com/), [Gemini](https://gemini.google.com/app), [Mistral](https://mistral.ai/) oder [Claude](https://claude.ai/login)), ist für die Vorbereitung der Einheiten ausdrücklich erlaubt und wird sogar empfohlen. Diese Werkzeuge können helfen, Konzepte zu verstehen, Codebeispiele nachzuvollziehen und alternative Erklärungen zu finden. Allerdings sollten Sie immer versuchen, die Übungsaufgaben selbständig zu lösen, um ein tiefes Verständnis der Materie zu entwickeln.
:::
