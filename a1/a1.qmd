...
Alternativ kann man, wenn sich die Daten ohnehin als Spalten in einem Data Frame befinden, die Funktion auch wie folgt aufrufen:
...
Mit dem zusätzlichen Argument `geom="line"` wird eine Liniengrafik erzeugt:
...
Mit den Argumenten `main`, `xlab` und `ylab` kann man den Titel sowie die Achsenbeschriftungen anpassen:
