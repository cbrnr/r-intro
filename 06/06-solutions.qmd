...
summary(penguins)  # jede der 3 Faktorspalten hat jeweils 3 Stufen
by(penguins[, 3:5], penguins$species, colMeans, na.rm=TRUE)
```

Laut `summary(penguins)` gibt es in den Spalten 3–6 jeweils 2 fehlende Werte und in der 7. Spalte 11 fehlende Werte.
