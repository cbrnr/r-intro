...
Die Datentypen der vier Spalten sind `<chr>`, `<dbl>`, `<dbl>`, `<dbl>` – d.h. das deutsche Zahlenformat wurde korrekt importiert. Alternativ könnte man auch `read_delim` mit den entsprechenden Argumenten verwenden:

```{r}
#| message: false
(df = read_delim("homework.csv", delim=";", locale=locale(decimal_mark=",")))
```
