...
Matrizen sind einfach Vektoren mit einem speziellen Dimensionsattribut, welches man mit der Funktion `dim()` abfragen und setzen kann:
...
Auch `rownames()` funktioniert, aber in der Praxis werden nur Spaltennamen gesetzt. Die Zeilennamen verändert man am besten nicht, diese sind dann beginnend mit 1 aufsteigend durchnummeriert.
...
Um solche Fehler zu vermeiden, sollte man generell die Schreibweise mit den doppelten eckigen Klammern verwenden.
:::
...
:::{.callout-important}
Das Komma darf niemals weggelassen werden, auch wenn man einen Index weglässt!
:::
